...
| Approach | Benefits |
| -------- | -------- |
| compression on the client side directly | a. leverage CPU of client-side<br>b. saves bandwidth<br>c. makes network faster |
| client-side doing the majority of the work | a. client-side sending to S3 directly<br>b. uploading the offsets to the server |
